...
from utils import initialize_cameras, detect_motion, detect_human, arrange_frames, send_telegram_alert, shutdown_email_worker, queue_email_alert
...
fps = 5
check_period = 5
notification_cooldown_period = 15 # 3 minutes
